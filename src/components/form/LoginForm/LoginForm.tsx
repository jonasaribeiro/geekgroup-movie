...
export const LoginForm = () => {
    ...
    return (
        ...
        <Input
                ...
                error={errors.email} id={""} placeholder={"Digite seu e-mail aqui..."}      />
      <Input
                label=''
                type='password'
                register={register('password')}
                error={errors.password} id={""} placeholder={"Digite sua senha aqui..."}      />
                <p>Não possui conta? <span> <Link to='/register'>Clique aqui</Link></span></p>
